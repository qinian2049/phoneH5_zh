...
$(document).ready(function(){
 ...
 function plus(self){
        ...
        var t=self.siblings(".numberOfArticle");
        var prices = parseFloat(self.siblings(".price").text());
        self.prop("disabled",false);
        var singles = self.parent().siblings(".singles");
        var thiss = self;
            if(parseInt(t.val())>=self.parents(".goodBox").attr("goods_inventory")){
        ...
        Datas({
                ...
                datas:{
                    ...
                    "goods_cart_id":self.parent().attr("id"),
                    "abs":self.prev().val()
                },
      ...
      //商品单选点击事件
      var user_Id;
    function singles(self){
        var Cur_singles = self;
   ...
   function Initialization(){
    ...
    function subtract(self){
        ...
        var singles = self.parent().siblings(".singles");
        var t=self.siblings(".numberOfArticle");
        var prices = parseFloat(self.prev().text());
        var thiss = self;
    ...
    //店铺全选
  function ShopLeverSelectAll(self){
        var  shop_cur = self;
...
function Fn(){
    ...
    Datas({
          ...
          datas:{
              ...
              "cart_session_id":$.session.get("cartSessionId"),
              "cart_type":cartType
          },
          success:function(data){
             ...
             if (data.status) {
                 ...
                 $(".wrapper .goodBox").each(function(index,item){
                  ...
                  var script=$("<script id='shop_car_js'>");
